...
#+begin_src emacs-lisp
(setq!
 doom-font (font-spec :family "Cascadia Mono NF" :size 10.0)
 ;; doom-font (font-spec :family "Roboto Mono" :size 15)
 doom-variable-pitch-font (font-spec :family "Noto Sans CJK KR")
 ;; doom-serif-font (font-spec :family "Libre Baskerville")
 doom-symbol-font (font-spec :family "Noto Sans CJK KR")
